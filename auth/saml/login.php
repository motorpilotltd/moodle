...
do {
    ...
    if (!empty($SESSION->wantsurl)) {
        $autologinurl->param('wantsurl', $SESSION->wantsurl);
    }
...
if ($frm and isset($frm->username)) { // Login WITH cookies.
    ...
    if ($user) {
        // User already supplied by auth plugin pre-login hook.
...
if (isloggedin() and !isguestuser()) {
    ...
    $PAGE->requires->js('/auth/saml/js/login.js', false);
}
