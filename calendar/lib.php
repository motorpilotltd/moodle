...
/* BEGIN CORE MOD */
        $whereclause .= " (e.eventtype <> 'lunchandlearn' AND e.userid $insqlusers AND e.courseid = 0 AND e.groupid = 0 AND e.categoryid = 0)";
/* END CORE MOD */
        ...
        if(!empty($whereclause)) $whereclause .= ' OR';
/* BEGIN CORE MOD */
        $whereclause .= " (e.eventtype <> 'lunchandlearn' AND e.userid != 0 AND e.courseid = 0 AND e.groupid = 0 AND e.categoryid = 0)";
/* END CORE MOD */
    } else if($users === false) {
...
/* BEGIN CORE MOD */
        $whereclause .= " (e.eventtype <> 'lunchandlearn' AND e.groupid $insqlgroups) ";
/* END CORE MOD */
        ...
        if(!empty($whereclause)) $whereclause .= ' OR ';
/* BEGIN CORE MOD */
        $whereclause .= " (e.eventtype <> 'lunchandlearn' AND e.groupid != 0)";
/* END CORE MOD */
    }
...
/* BEGIN CORE MOD */
        $whereclause .= " (e.eventtype <> 'lunchandlearn' AND e.groupid = 0 AND e.courseid $insqlcourses)";
/* END CORE MOD */
        ...
        if(!empty($whereclause)) $whereclause .= ' OR';
/* BEGIN CORE MOD */
        $whereclause .= " (e.eventtype <> 'lunchandlearn' AND e.groupid = 0 AND e.courseid != 0)";
/* END CORE MOD */
    }
