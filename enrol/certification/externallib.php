 ...
 * @since     Moodle 2.6
 */
class enrol_certification_external extends external_api {
    ...
    public static function get_instance_info($instanceid) {
        ...
        $enrolplugin = enrol_get_plugin('certification');
        ...
        $enrolinstance = $DB->get_record('certification', array('id' => $params['instanceid']), '*', MUST_EXIST);
