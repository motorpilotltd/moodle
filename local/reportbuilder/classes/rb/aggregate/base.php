...
namespace local_reportbuilder\rb\aggregate;
...
abstract class base {
    ...
    public static function get_types() {
        ...
        foreach (scandir(__DIR__) as $filename) {
            ...
            $classname = '\local_reportbuilder\rb\aggregate\\' . $name;
    ...
    public static function get_options() {
        ...
        foreach (self::get_types() as $name => $classname) {
            $options[$classname::get_typename()][$name] = get_string("aggregatetype{$name}_name", 'local_reportbuilder');
        }
    ...
    public static function require_column_heading_strings() {
        ...
        foreach (self::get_types() as $name => $classname) {
            $PAGE->requires->string_for_js("aggregatetype{$name}_heading", 'local_reportbuilder');
        }
    }
    ...
    public static function get_typename() {
        return get_string('advancedgroupaggregate', 'local_reportbuilder');
    }
