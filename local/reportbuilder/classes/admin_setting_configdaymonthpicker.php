 ...
 *
 */
class local_reportbuilder_admin_setting_configdaymonthpicker extends admin_setting {
    /**
     * Constructor
    ...
    public function output_html($data, $query='') {
        ...
        $return .= html_writer::tag('label', get_string('financialyeardaystart', 'local_reportbuilder', $this->visiblename),
            array('for' => 'menu' . $this->get_full_name() . 'd', 'class' => 'accesshide'));
        $return .= html_writer::select($days, $this->get_full_name() . '[d]' , (int)$day);
        $return .= html_writer::tag('label', get_string('financialyearmonthstart', 'local_reportbuilder', $this->visiblename),
