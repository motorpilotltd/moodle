...
class rb_global_restriction_set implements Iterator {
    ...
    public static function create_from_ids($reportrecord, array $globalrestrictionids = null) {
        ...
        $selected = $DB->get_records_sql('SELECT * FROM {report_builder_global_restr} WHERE id ' . $sql, $params);
    ...
    public static function convert_qm_named($sql, array $params = null, $prefix='conv') {
        ...
        while ($pos !== false) {
            ...
            $unique = \local_reportbuilder\dblib\base::getbdlib()->get_unique_param($prefix);
     ...
     * @return stdClass[] List of available restrictions ids as (id => stdClass record of report_builder_global_restr)
     */
    public static function get_user_all_restrictions($userid, $nocache = false) {
        ...
        $restrictions = $DB->get_records('report_builder_global_restr', array('active' => 1), 'sortorder ASC');
