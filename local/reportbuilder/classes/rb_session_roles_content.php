...
class rb_session_roles_content extends rb_base_content {
    ...
    public function text_restriction($title, $reportid) {
        ...
        return get_string('sessionroles_txtrestr', 'local_reportbuilder', $a);
    }
    ...
    public function form_template(&$mform, $reportid, $title) {
        ...
        $mform->addElement('header', 'session_roles', get_string('showbyx', 'local_reportbuilder', lcfirst($title)));
        ...
        $mform->addGroup($checkgroup, 'session_roles_group',
            get_string('includesessionroles', 'local_reportbuilder'), html_writer::empty_tag('br'), false);
