...
class rb_report_access_content extends rb_base_content {
    ...
    public function sql_restriction($field, $reportid) {
        ...
        $manageuserreports = has_capability('local/reportbuilder:managereports', $syscontext);
        $manageembeddedreports = has_capability('local/reportbuilder:manageembeddedreports', $syscontext);
    ...
    public function text_restriction($title, $reportid) {
        return get_string('accessiblereportsonly', 'local_reportbuilder');
    }
    ...
    public function form_template(&$mform, $reportid, $title) {
        ...
        $mform->addElement('header', 'report_access', get_string('showbyx', 'local_reportbuilder', get_string('reportaccess', 'local_reportbuilder')));
        $mform->setExpanded('report_access');
        $mform->addElement('checkbox', 'report_access_enable', '',
            get_string('showbasedonx', 'local_reportbuilder', get_string('reportaccess', 'local_reportbuilder')));
