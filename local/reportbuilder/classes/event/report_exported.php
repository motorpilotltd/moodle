...
namespace local_reportbuilder\event;
...
class report_exported extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventreportexported', 'local_reportbuilder');
    }
    ...
    protected function get_legacy_logdata() {
        ...
        $logurl = str_replace($CFG->wwwroot . '/local/reportbuilder/', '', $logurl);
    ...
    public function get_url() {
        return new \moodle_url('/local/reportbuilder/report.php', array('id' => $this->objectid));
    }
