 ...
 */
class local_reportbuilder_admin_setting_configexportoptions extends admin_setting_configmulticheckbox {
    /**
    ...
    public function __construct() {
        ...
        parent::__construct('reportbuilder/exportoptions',
            new lang_string('exportoptions', 'local_reportbuilder'),
            new lang_string('reportbuilderexportoptions_help', 'local_reportbuilder'),
            $defaultoptions,
            null
        );
    }
    ...
    public function load_choices() {
        ...
        $this->choices = \local_reportbuilder\tabexport_writer::get_export_classes();
        ...
        $this->choices['fusion'] = new lang_string('exportfusion', 'local_reportbuilder');
