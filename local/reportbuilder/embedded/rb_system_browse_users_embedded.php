    ...
    public function __construct($data) {
        ...
        $this->columns = array(
            ...
            array(
                ...
                'heading' => get_string('useremail', 'local_reportbuilder'),
            ),
            array(
                'type' => 'user',
                'value' => 'deleted',
                'heading' => get_string('userstatus', 'local_reportbuilder'),
            ),
            array(
                'type' => 'user',
                'value' => 'lastloginrelative',
                'heading' => get_string('lastlogin', 'local_reportbuilder'),
            ),
            array(
                'type' => 'user',
                'value' => 'actions',
                'heading' => get_string('actions', 'local_reportbuilder'),
            ),
        );
        ...
        $this->filters = array(
            ...
            array(
                ...
                'value' => 'emailunobscured',
                'advanced' => 1,
                'fieldname' => get_string('useremail', 'local_reportbuilder'),
            ),
        );
