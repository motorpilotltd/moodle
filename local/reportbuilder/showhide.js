...
M.local_reportbuilder_showhide = M.local_reportbuilder_showhide || {
    ...
    init: function(Y, args) {
        ...
        if (typeof $ === 'undefined') {
            throw new Error('M.local_reportbuilder_showhide.init()-> jQuery dependency required for this module to function.');
        }
        ...
        totaraDialogs[name] = new totaraDialog(
            ...
            {
                buttons: buttons,
                title: '<h2>' + M.util.get_string('showhidecolumns', 'local_reportbuilder') + '</h2>'
            },
