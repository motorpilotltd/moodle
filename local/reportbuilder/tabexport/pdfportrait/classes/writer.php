...
use \local_reportbuilder\tabexport_source;
use \local_reportbuilder\tabexport_writer;
...
class writer extends tabexport_writer {
    ...
    protected function create_pdf() {
        ...
        foreach ($this->source as $record_data) {
            ...
            if (1024 <= $mramuse and !PHPUNIT_TEST) {
                if (defined('CLI_SCRIPT') && CLI_SCRIPT) {
                    ...
                    $html .= get_string('exportpdf_mramlimitexceeded', 'local_reportbuilder', 1024);
                    $html .= '</td></tr>';
                    break;
                } else {
                    // Notice message.
                    print_error('exportpdf_mramlimitexceeded', 'local_reportbuilder', '', 1024);
                }
            }
        }
        $html .= '</tbody></table>';
        ...
        if ($customheader === null) {
            ...
            $recordscount = get_string('x' . $resultstr, 'local_reportbuilder', $count);
