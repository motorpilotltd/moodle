...
$row[] = new tabobject('graph', $CFG->wwwroot . '/local/reportbuilder/graph.php?reportid=' . $id, get_string('graph', 'local_reportbuilder'));
...
$row[] = new tabobject('performance', $CFG->wwwroot . '/local/reportbuilder/performance.php?id=' . $id, get_string('performance', 'local_reportbuilder'));
