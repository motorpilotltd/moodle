...
if ($reportid) {
    ...
    if (!reportbuilder::is_capable($reportid)) {
        ...
        throw new moodle_exception('nopermissionstoviewrestrictions', 'local_reportbuilder');
    }
}
...
echo get_string('chooserestrictiondesc', 'local_reportbuilder');
echo html_writer::div(get_string('error:globalrestrictionrequired', 'local_reportbuilder'), 'notifyproblem error-required alert alert-warning');
