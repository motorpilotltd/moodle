...
$returnurl = new moodle_url('/local/reportbuilder/graph.php', array('reportid' => $id));
...
if ($fromform = $mform->get_data()) {
    ...
    notice(get_string('graph_updated', 'local_reportbuilder'), $returnurl, array('class' => 'notifysuccess'));
}
