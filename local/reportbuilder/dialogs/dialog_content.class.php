...
class totara_dialog_content {
     ...
     * @var     string
     */
    public $lang_file = 'local_reportbuilder';
     ...
     * @var     string
     */
    public $search_code = '/local/reportbuilder/dialogs/search.php';
    ...
    public function generate_markup() {
        ...
        $markup .= '  <li><a href="#browse-tab">'.get_string('browse', 'local_reportbuilder').'</a></li>';
