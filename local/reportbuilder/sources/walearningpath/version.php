...
$plugin->version  = 2020050800;       // The current module version (Date: YYYYMMDDXX).
$plugin->requires = 2016120504;       // Requires this Moodle version.
$plugin->component = 'rbsource_walearningpath';  // To check on upgrade, that module sits in correct place
