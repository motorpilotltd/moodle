    ...
    protected function define_columnoptions() {
        ...
        $columnoptions = array(
            // Assignment name.
                new rb_column_option(
                        'base',
                        'name',
                        get_string('assignmentname', 'rbsource_assignsummary'),
            ...
            // Assignment intro.
                new rb_column_option(
                        'base',
                        'intro',
                        get_string('assignmentintro', 'rbsource_assignsummary'),
            ...
            // Assignment maxgrade.
                new rb_column_option(
                        'base',
                        'maxgrade',
                        get_string('assignmentmaxgrade', 'rbsource_assignsummary'),
            ...
            // User count.
                new rb_column_option(
                        'base',
                        'user_count',
                        get_string('usercount', 'rbsource_assignsummary'),
                        'base.user_count'
                )
        );
        ...
        foreach ($cols as $col) {
            $columnoptions[] = new rb_column_option(
                    'base',
                    $col,
                    get_string("{$col}grade", 'rbsource_assignsummary'),
                    "base.{$col}_grade",
        ...
        foreach ($cols as $col) {
            $columnoptions[] = new rb_column_option(
                    'base',
                    "{$col}_timemodified",
                    get_string("{$col}lastmodified", 'rbsource_assignsummary'),
        ...
        foreach ($cols as $col) {
            $columnoptions[] = new rb_column_option(
                    'base',
                    "{$col}_timemarked",
                    get_string("{$col}lastmarked", 'rbsource_assignsummary'),
    ...
    protected function define_filteroptions() {
        ...
        foreach ($cols as $col) {
            $a[] = new rb_filter_option(
                    'base',
                    $col,
                    get_string("assignment{$col}", 'rbsource_assignsummary'),
                    'text'
            );
        }
