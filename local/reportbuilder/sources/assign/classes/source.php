...
class source extends rb_base_source {
        ...
        $columnoptions = array(
            // Assignment name.
                new rb_column_option(
                        'assignment',
                        'name',
                        get_string('assignmentname', 'rbsource_assign'),
                        'assign.name',
                        array(
                                'joins' => 'assign',
                                'dbdatatype' => 'char',
            ...
            // Assignment intro.
                new rb_column_option(
                        'assignment',
                        'intro',
                        get_string('assignmentintro', 'rbsource_assign'),
                        'assign.intro',
                        array(
                                'joins' => 'assign',
                                'dbdatatype' => 'text',
            ...
            // Assignment status.
                new rb_column_option(
                        'assignment',
                        'status',
                        get_string('submissionstatus', 'rbsource_assign'),
            ...
            // Grade scale values.
                new rb_column_option(
                        'scale',
                        'scale_values',
                        get_string('gradescalevalues', 'rbsource_assign'),
                        'scale.scale',
                        array(
            ...
            // Submission grade.
                new rb_column_option(
                        'base',
                        'grade',
                        get_string('submissiongrade', 'rbsource_assign'),
                        'assign_grades.grade',
                        array(
            ...
            // Feedback comment.
                new rb_column_option(
                        'base',
                        'comment',
                        get_string('feedbackcomment', 'rbsource_assign'),
            ...
            // Submission last modified date.
                new rb_column_option(
                        'base',
                        'timemodified',
                        get_string('lastmodifiedsubmission', 'rbsource_assign'),
                        'base.timemodified',
                        array(
            ...
            // Grade last modified date.
                new rb_column_option(
                        'base',
                        'timemarked',
                        get_string('lastmodifiedgrade', 'rbsource_assign'),
            ...
            // Max grade.
                new rb_column_option(
                        'grade_grades',
                        'maxgrade',
                        get_string('maxgrade', 'rbsource_assign'),
            ...
            // Min grade.
                new rb_column_option(
                        'grade_grades',
                        'mingrade',
                        get_string('mingrade', 'rbsource_assign'),
        ...
        $filteroptions = array(
            ...
            // Submission status.
                new rb_filter_option(
                        ...
                        array(
                                'selectchoices' => array(
                                        'notsubmitted' => get_string('status_notsubmitted', 'rbsource_assign'),
                                        'submitted' => get_string('status_submitted', 'rbsource_assign'),
                                        'graded' => get_string('status_graded', 'rbsource_assign')),
                        )
                ),
    ...
    public function rb_display_submissiongrade($field, $record, $isexport) {
        ...
        if ((integer)$field < 0 || empty($field)) {
            return get_string('nograde', 'rbsource_assign');
        }
