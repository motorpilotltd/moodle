...
class source extends rb_base_source {
    ...
    public function __construct() {
        ...
        $this->sourcetitle = get_string('sourcetitle', 'rbsource_sitelogs');
    ...
    protected function define_columnoptions() {
        ...
        $columnoptions = array(
                new rb_column_option(
                        'log',
                        'time',
                        get_string('time', 'rbsource_sitelogs'),
                        'base.time',
                ...
                new rb_column_option(
                        'log',
                        'ip',
                        get_string('ip', 'rbsource_sitelogs'),
                        'base.ip',
                ...
                new rb_column_option(
                        'log',
                        'module',
                        get_string('module', 'rbsource_sitelogs'),
                        'base.module',
                ...
                new rb_column_option(
                        'log',
                        'cmid',
                        get_string('cmid', 'rbsource_sitelogs'),
                        'base.cmid'
                ),
                new rb_column_option(
                        'log',
                        'action',
                        get_string('action', 'rbsource_sitelogs'),
                ...
                new rb_column_option(
                        'log',
                        'actionlink',
                        get_string('actionlink', 'rbsource_sitelogs'),
                        $DB->sql_concat('base.module', "' '", 'base.action'),
                        array(
                                'displayfunc' => 'link_action',
                                'defaultheading' => get_string('action', 'rbsource_sitelogs'),
                ...
                new rb_column_option(
                        'log',
                        'url',
                        get_string('url', 'rbsource_sitelogs'),
                        'base.url',
                        array('dbdatatype' => 'char',
                              'outputformat' => 'text')
                ),
                new rb_column_option(
                        'log',
                        'info',
                        get_string('info', 'rbsource_sitelogs'),
                        'base.info',
                        array('dbdatatype' => 'char',
                              'outputformat' => 'text')
                ),
    ...
    protected function define_filteroptions() {
        $filteroptions = array(
                new rb_filter_option(
                        'log',     // type
                        'action',  // value
                        get_string('action', 'rbsource_sitelogs'),  // label
                        'text',    // filtertype
                        array()    // options
                )
        );
    ...
    protected function define_contentoptions() {
        ...
        $contentoptions[] = new rb_content_option(
                'date',
                get_string('date', 'rbsource_sitelogs'),
                'base.time'
        );
