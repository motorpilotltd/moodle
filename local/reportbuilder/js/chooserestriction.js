...
M.local_reportbuilder_chooserestriction = M.local_reportbuilder_chooserestriction || {
    Y: null,
    reportid: null,
    pageurl: null,
    ...
    addDialog: function () {
        var selected = [];
        var baseurl = M.cfg.wwwroot + '/local/reportbuilder/';
        var title = M.util.get_string('chooserestrictiontitle', 'local_reportbuilder');
        ...
        var buttonObj = {};
        buttonObj[M.util.get_string('save', 'local_reportbuilder')] = function() {
