...
M.local_reportbuilder_expand = M.local_reportbuilder_expand || {
    /** Selectors. */
    SELECTORS: {
    ...
    init: function(Y, args) {
        $('body').on('click', '.rb-display-expand', M.local_reportbuilder_expand.displayExpand);
        $('body').on('click', this.SELECTORS.ENROLMENTBUTTONS, M.local_reportbuilder_expand.clickEnrol);
