...
diff --git a/local/reportbuilder/js/lib/jquery.dataTables.js b/local/reportbuilder/js/lib/jquery.dataTables.js
index 4440ba6..4f296fc 100644
--- a/local/reportbuilder/js/lib/jquery.dataTables.js
+++ b/local/reportbuilder/js/lib/jquery.dataTables.js
@@ -29,15 +29,7 @@
 (function( factory ) {
        "use strict";
