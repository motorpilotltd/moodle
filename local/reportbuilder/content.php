...
$returnurl = new moodle_url('/local/reportbuilder/content.php', array('id' => $id));
...
if ($fromform = $mform->get_data()) {
    ...
    $report = new reportbuilder($id);
    \local_reportbuilder\event\report_updated::create_from_report($report, 'content')->trigger();
