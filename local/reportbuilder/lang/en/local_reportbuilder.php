...
$string['geo_region'] = 'Geo code';
$string['region_name'] = 'Region';
$string['classname'] = 'Class name';
$string['classtype'] = 'Class type';
$string['location'] = 'Location';
$string['classstartdate'] = 'Start date';
$string['classenddate'] = 'End date';
...
$string['bookingplaceddate'] = 'Booking date';
$string['expirydate'] = 'Expiry date';
$string['coursecode'] = 'Course code';
$string['courseregion'] = 'Course region';
$string['tapsarchived'] = 'Exclude archived courses';
$string['excludearchivedcontent'] = 'Exclude archived content';

$string['EMPLOYEE_NUMBER'] = 'Staff ID';
$string['FIRST_NAME'] = 'First Name';
$string['MIDDLE_NAMES'] = 'Middle Names';
$string['LAST_NAME'] = 'Last Name';
$string['KNOWN_AS'] = 'Known As';
$string['FULL_NAME'] = 'Full Name';
$string['EMAIL_ADDRESS'] = 'Email Address';
$string['INTERNAL_LOCATION'] = 'Internal Location';
$string['LATEST_HIRE_DATE'] = 'Latest Hire Date';
$string['GRADE'] = 'Grade';
$string['CORE_JOB_TITLE'] = 'Core Job Title';
$string['GEO_REGION'] = 'GEO Region';
$string['COMPANY_CODE'] = 'Company Code';
$string['CENTRE_CODE'] = 'Centre Code';
$string['CENTRE_NAME'] = 'Centre Name';
$string['COMPANYCENTREARUPUNIT'] = 'Company Centre Arup Unit';
$string['SUP_EMPLOYEE_NUMBER'] = 'SUP Employee Number';
$string['EMPLOYMENT_CATEGORY'] = 'Employment Category';
$string['ASSIGNMENT_STATUS'] = 'Assignment Status';
$string['REGION_NAME'] = 'Region Name';
$string['LOCATION_NAME'] = 'Location Name';
$string['LEAVER_FLAG'] = 'Leaver Flag';
$string['ACTUAL_TERMINATION_DATE'] = 'Actual Termination Date';
