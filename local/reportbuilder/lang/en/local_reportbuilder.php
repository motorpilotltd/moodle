...
$string['graphtypedoughnut'] = 'Doughnut';
$string['graphtypesmoothline'] = 'Smoothed line';
...
$string['showfullscreen'] = 'Show report in fullscreen mode';
...
$string['tablecolumns'] = 'Table columns';
...
$string['closefullscreen'] = 'Close fullscreen mode';
$string['column'] = 'Column';
...
$string['userwalearningpath'] = 'User learning paths';
...
$string['pathtochrome'] = 'Path to chrome executable';
$string['pathtochrome_help'] = 'Path to chrome executable';

$string['language'] = 'Language';
$string['lang_aa'] = 'Afar';
$string['lang_ab'] = 'Abkhazian';
$string['lang_ae'] = 'Avestan';
$string['lang_af'] = 'Afrikaans';
$string['lang_ak'] = 'Akan';
$string['lang_am'] = 'Amharic';
$string['lang_an'] = 'Aragonese';
$string['lang_ar'] = 'Arabic';
$string['lang_as'] = 'Assamese';
$string['lang_av'] = 'Avaric';
$string['lang_ay'] = 'Aymara';
$string['lang_az'] = 'Azerbaijani';
$string['lang_ba'] = 'Bashkir';
$string['lang_be'] = 'Belarusian';
$string['lang_bg'] = 'Bulgarian';
$string['lang_bh'] = 'Bihari languages';
$string['lang_bm'] = 'Bambara';
$string['lang_bi'] = 'Bislama';
$string['lang_bn'] = 'Bengali';
$string['lang_bo'] = 'Tibetan';
$string['lang_br'] = 'Breton';
$string['lang_bs'] = 'Bosnian';
$string['lang_ca'] = 'Catalan; Valencian';
$string['lang_ce'] = 'Chechen';
$string['lang_ch'] = 'Chamorro';
$string['lang_co'] = 'Corsican';
$string['lang_cr'] = 'Cree';
$string['lang_cs'] = 'Czech';
$string['lang_cu'] = 'Church Slavic; Old Slavonic; Church Slavonic; Old Bulgarian; Old Church Slavonic';
$string['lang_cv'] = 'Chuvash';
$string['lang_cy'] = 'Welsh';
$string['lang_da'] = 'Danish';
$string['lang_de'] = 'German';
$string['lang_dv'] = 'Divehi; Dhivehi; Maldivian';
$string['lang_dz'] = 'Dzongkha';
$string['lang_ee'] = 'Ewe';
$string['lang_el'] = 'Greek, Modern (1453-)';
$string['lang_en'] = 'English';
$string['lang_eo'] = 'Esperanto';
$string['lang_es'] = 'Spanish; Castilian';
$string['lang_et'] = 'Estonian';
$string['lang_eu'] = 'Basque';
$string['lang_fa'] = 'Persian';
$string['lang_ff'] = 'Fulah';
$string['lang_fi'] = 'Finnish';
$string['lang_fj'] = 'Fijian';
$string['lang_fo'] = 'Faroese';
$string['lang_fr'] = 'French';
$string['lang_fy'] = 'Western Frisian';
$string['lang_ga'] = 'Irish';
$string['lang_gd'] = 'Gaelic; Scottish Gaelic';
$string['lang_gl'] = 'Galician';
$string['lang_gn'] = 'Guarani';
$string['lang_gu'] = 'Gujarati';
$string['lang_gv'] = 'Manx';
$string['lang_ha'] = 'Hausa';
$string['lang_he'] = 'Hebrew';
$string['lang_hi'] = 'Hindi';
$string['lang_ho'] = 'Hiri Motu';
$string['lang_hr'] = 'Croatian';
$string['lang_ht'] = 'Haitian; Haitian Creole';
$string['lang_hu'] = 'Hungarian';
$string['lang_hy'] = 'Armenian';
$string['lang_hz'] = 'Herero';
$string['lang_ia'] = 'Interlingua (International Auxiliary Language Association)';
$string['lang_id'] = 'Indonesian';
$string['lang_ie'] = 'Interlingue; Occidental';
$string['lang_ig'] = 'Igbo';
$string['lang_ii'] = 'Sichuan Yi; Nuosu';
$string['lang_ik'] = 'Inupiaq';
$string['lang_io'] = 'Ido';
$string['lang_is'] = 'Icelandic';
$string['lang_it'] = 'Italian';
$string['lang_iu'] = 'Inuktitut';
$string['lang_ja'] = 'Japanese';
$string['lang_jv'] = 'Javanese';
$string['lang_ka'] = 'Georgian';
$string['lang_kg'] = 'Kongo';
$string['lang_ki'] = 'Kikuyu; Gikuyu';
$string['lang_kj'] = 'Kuanyama; Kwanyama';
$string['lang_kk'] = 'Kazakh';
$string['lang_kl'] = 'Kalaallisut; Greenlandic';
$string['lang_km'] = 'Central Khmer';
$string['lang_kn'] = 'Kannada';
$string['lang_ko'] = 'Korean';
$string['lang_kr'] = 'Kanuri';
$string['lang_ks'] = 'Kashmiri';
$string['lang_ku'] = 'Kurdish';
$string['lang_kv'] = 'Komi';
$string['lang_kw'] = 'Cornish';
$string['lang_ky'] = 'Kirghiz; Kyrgyz';
$string['lang_la'] = 'Latin';
$string['lang_lb'] = 'Luxembourgish; Letzeburgesch';
$string['lang_lg'] = 'Ganda';
$string['lang_li'] = 'Limburgan; Limburger; Limburgish';
$string['lang_ln'] = 'Lingala';
$string['lang_lo'] = 'Lao';
$string['lang_lt'] = 'Lithuanian';
$string['lang_lu'] = 'Luba-Katanga';
$string['lang_lv'] = 'Latvian';
$string['lang_mg'] = 'Malagasy';
$string['lang_mh'] = 'Marshallese';
$string['lang_mi'] = 'Maori';
$string['lang_mk'] = 'Macedonian';
$string['lang_ml'] = 'Malayalam';
$string['lang_mn'] = 'Mongolian';
$string['lang_mr'] = 'Marathi';
$string['lang_ms'] = 'Malay';
$string['lang_mt'] = 'Maltese';
$string['lang_my'] = 'Burmese';
$string['lang_na'] = 'Nauru';
$string['lang_nb'] = 'Bokmål, Norwegian; Norwegian Bokmål';
$string['lang_nd'] = 'Ndebele, North; North Ndebele';
$string['lang_ne'] = 'Nepali';
$string['lang_ng'] = 'Ndonga';
$string['lang_nl'] = 'Dutch; Flemish';
$string['lang_nn'] = 'Norwegian Nynorsk; Nynorsk, Norwegian';
$string['lang_no'] = 'Norwegian';
$string['lang_nr'] = 'Ndebele, South; South Ndebele';
$string['lang_nv'] = 'Navajo; Navaho';
$string['lang_ny'] = 'Chichewa; Chewa; Nyanja';
$string['lang_oc'] = 'Occitan (post 1500)';
$string['lang_oj'] = 'Ojibwa';
$string['lang_om'] = 'Oromo';
$string['lang_or'] = 'Oriya';
$string['lang_os'] = 'Ossetian; Ossetic';
$string['lang_pa'] = 'Panjabi; Punjabi';
$string['lang_pi'] = 'Pali';
$string['lang_pl'] = 'Polish';
$string['lang_ps'] = 'Pushto; Pashto';
$string['lang_pt'] = 'Portuguese';
$string['lang_qu'] = 'Quechua';
$string['lang_rm'] = 'Romansh';
$string['lang_rn'] = 'Rundi';
$string['lang_ro'] = 'Romanian; Moldavian; Moldovan';
$string['lang_ru'] = 'Russian';
$string['lang_rw'] = 'Kinyarwanda';
$string['lang_sa'] = 'Sanskrit';
$string['lang_sc'] = 'Sardinian';
$string['lang_sd'] = 'Sindhi';
$string['lang_se'] = 'Northern Sami';
$string['lang_sg'] = 'Sango';
$string['lang_si'] = 'Sinhala; Sinhalese';
$string['lang_sk'] = 'Slovak';
$string['lang_sl'] = 'Slovenian';
$string['lang_sm'] = 'Samoan';
$string['lang_sn'] = 'Shona';
$string['lang_so'] = 'Somali';
$string['lang_sq'] = 'Albanian';
$string['lang_sr'] = 'Serbian';
$string['lang_ss'] = 'Swati';
$string['lang_st'] = 'Sotho, Southern';
$string['lang_su'] = 'Sundanese';
$string['lang_sv'] = 'Swedish';
$string['lang_sw'] = 'Swahili';
$string['lang_ta'] = 'Tamil';
$string['lang_te'] = 'Telugu';
$string['lang_tg'] = 'Tajik';
$string['lang_th'] = 'Thai';
$string['lang_ti'] = 'Tigrinya';
$string['lang_tk'] = 'Turkmen';
$string['lang_tl'] = 'Tagalog';
$string['lang_tn'] = 'Tswana';
$string['lang_to'] = 'Tonga (Tonga Islands)';
$string['lang_tr'] = 'Turkish';
$string['lang_ts'] = 'Tsonga';
$string['lang_tt'] = 'Tatar';
$string['lang_tw'] = 'Twi';
$string['lang_ty'] = 'Tahitian';
$string['lang_ug'] = 'Uighur; Uyghur';
$string['lang_uk'] = 'Ukrainian';
$string['lang_ur'] = 'Urdu';
$string['lang_uz'] = 'Uzbek';
$string['lang_ve'] = 'Venda';
$string['lang_vi'] = 'Vietnamese';
$string['lang_vo'] = 'Volapük';
$string['lang_wa'] = 'Walloon';
$string['lang_wo'] = 'Wolof';
$string['lang_xh'] = 'Xhosa';
$string['lang_yi'] = 'Yiddish';
$string['lang_yo'] = 'Yoruba';
