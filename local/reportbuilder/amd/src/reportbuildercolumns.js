        ...
        var reportbuildercolumns = {
            ...
            rb_init_deletebuttons: function () {
                ...
                $('.reportbuilderform table .deletecolbtn').on('click', function (e) {
                    ...
                    var confirmstr = M.util.get_string('confirmcoldelete', 'local_reportbuilder');
            ...
            rb_get_btn_add: function (reportid) {
                return $('<a href="' + M.cfg.wwwroot + '/local/reportbuilder/columns.php?id=' + reportid + '" class="addcolbtn"><input class="btn btn-secondary" type="button" value="' + M.util.get_string('add', 'local_reportbuilder') + '" /></a>');
            }
        };
        return reportbuildercolumns;
    });
