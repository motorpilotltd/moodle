...
class local_reportbuilder_rb_findcertifications_embedded_cache_testcase extends reportcache_advanced_testcase {
    // testcase data
    protected $report_builder_data = array('id' => 7, 'fullname' => 'Find Programs', 'shortname' => 'findcertifications',
                                           'source' => 'program', 'hidden' => 1, 'embedded' => 1);

    protected $report_builder_columns_data = array(
                        array('id' => 29, 'reportid' => 7, 'type' => 'certif', 'value' => 'proglinkicon',
    ...
    protected $report_builder_filters_data = array(
                        array('id' => 16, 'reportid' => 7, 'type' => 'certif', 'value' => 'fullname',
     ...
     */
    public function test_findcertifications($usecache) {
        $this->resetAfterTest();
        if ($usecache) {
