...
class local_reportbuilder_graph_testcase extends advanced_testcase {
    use local_reportbuilder\phpunit\report_testing;

    public function test_normalize_numeric_value() {
        $this->assertSame(111,    local_reportbuilder\local\graph::normalize_numeric_value('111'));
        $this->assertSame(-1e10,  local_reportbuilder\local\graph::normalize_numeric_value('-1e10'));
        $this->assertSame(111,    local_reportbuilder\local\graph::normalize_numeric_value(111));
        $this->assertSame(11.1,   local_reportbuilder\local\graph::normalize_numeric_value(11.1));
        $this->assertSame(0,      local_reportbuilder\local\graph::normalize_numeric_value(0));
        $this->assertSame(0,      local_reportbuilder\local\graph::normalize_numeric_value('0'));
        $this->assertSame(0.0,    local_reportbuilder\local\graph::normalize_numeric_value('0.0'));
        $this->assertSame(111,    local_reportbuilder\local\graph::normalize_numeric_value(' 111 '));
        $this->assertSame(111.11, local_reportbuilder\local\graph::normalize_numeric_value('111.11'));
        $this->assertSame(111.11, local_reportbuilder\local\graph::normalize_numeric_value('111,11'));
        $this->assertSame(99,     local_reportbuilder\local\graph::normalize_numeric_value('99%'));
        $this->assertSame(99,     local_reportbuilder\local\graph::normalize_numeric_value('99 %'));
        $this->assertSame(0,      local_reportbuilder\local\graph::normalize_numeric_value('1 111'));
        $this->assertSame(0,      local_reportbuilder\local\graph::normalize_numeric_value('111,111.111'));
        $this->assertSame(0,      local_reportbuilder\local\graph::normalize_numeric_value('%99'));
        $this->assertSame(0,      local_reportbuilder\local\graph::normalize_numeric_value('  '));
        $this->assertSame(0,      local_reportbuilder\local\graph::normalize_numeric_value(''));
        $this->assertSame(0,      local_reportbuilder\local\graph::normalize_numeric_value(null));
        $this->assertSame(0,      local_reportbuilder\local\graph::normalize_numeric_value('abc'));
        $this->assertSame(0,      local_reportbuilder\local\graph::normalize_numeric_value(true));
        $this->assertSame(0,      local_reportbuilder\local\graph::normalize_numeric_value(false));
        $this->assertSame(10,     local_reportbuilder\local\graph::normalize_numeric_value(012));
        $this->assertSame(12.0,   local_reportbuilder\local\graph::normalize_numeric_value('012')); // No octal support in strings - cast to float.
        $this->assertSame(800.0,  local_reportbuilder\local\graph::normalize_numeric_value('0800')); // No octal support in strings - cast to float.
        $this->assertSame(496,    local_reportbuilder\local\graph::normalize_numeric_value(0x1f0));
        $this->assertEquals(0,    local_reportbuilder\local\graph::normalize_numeric_value('0x1f0')); // No hexadecimal support in strings - cast to float. PHP7 returns 0, older 0.0.
        $this->assertSame(255,    local_reportbuilder\local\graph::normalize_numeric_value(0b11111111));
        $this->assertSame(0,      local_reportbuilder\local\graph::normalize_numeric_value('0b11111111')); // No binary support in strings.
    }
