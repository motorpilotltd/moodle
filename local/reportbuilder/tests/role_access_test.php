...
class local_reportbuilder_role_access_testcase extends advanced_testcase {
    ...
    public function test_get_all_access_plugins() {
        ...
        foreach ($result as $name => $instance) {
            ...
            $this->assertInstanceOf('local_reportbuilder\rb\access\base', $instance);
        }
    }
    ...
    /**
     * Set role access restrictions - this code mimics \local_reportbuilder\rb\access\role::form_process().
     * @param int $reportid
