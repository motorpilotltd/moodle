...
class local_reportbuilder_display_testcase extends advanced_testcase {
    ...
    public function test_aggregation() {
        ...
        $this->assertSame('<img src="https://www.example.com/moodle/theme/image.php/_s/' . $theme . '/local_reportbuilder/1/courseicons/business-modelling" id="icon_preview" class="course_icon" alt="volba1" title="volba1" />', $processed[3]);
