...
class local_reportbuilder_events_testcase extends advanced_testcase {
    ...
    public function test_report_created_event() {
        ...
        $event = \local_reportbuilder\event\report_created::create_from_report($report, false);
        $event->trigger();
        $data = $event->get_data();
    ...
    public function test_report_updated_event() {
        ...
        $event = \local_reportbuilder\event\report_updated::create_from_report($report, 'columns');
        $event->trigger();
        $data = $event->get_data();
        $this->assertSame($report, $event->get_report());
        $this->assertSame($report->_id, $event->objectid);
    ...
    public function test_report_deleted_event() {
        ...
        $event = \local_reportbuilder\event\report_deleted::create_from_report($report, false);
        $event->trigger();
        $data = $event->get_data();
        $this->assertSame($report, $event->get_report());
        $this->assertSame($report->_id, $event->objectid);
        ...
        $event = \local_reportbuilder\event\report_deleted::create_from_report($report, true);
        $event->trigger();
        $data = $event->get_data();
        $this->assertSame($report, $event->get_report());
        $this->assertSame($report->_id, $event->objectid);
    ...
    public function test_report_cloned_event() {
        ...
        $event = \local_reportbuilder\event\report_cloned::create_from_report($report);
        $event->trigger();
        $data = $event->get_data();
        $this->assertSame($report, $event->get_report());
        $this->assertSame($report->_id, $event->objectid);
    ...
    public function test_report_viewed_event() {
        ...
        $event = \local_reportbuilder\event\report_viewed::create_from_report($report);
        $event->trigger();
        $data = $event->get_data();
        $this->assertSame($report, $event->get_report());
        $this->assertSame($report->_id, $event->objectid);
    ...
    public function test_report_exported_event() {
        ...
        $event = \local_reportbuilder\event\report_exported::create_from_report($report, 'pdflandscape');
        $event->trigger();
        $data = $event->get_data();
        $this->assertSame($report, $event->get_report());
        $this->assertSame($report->_id, $event->objectid);
