...
Feature: Global restriction initial display setting
  ...
  Scenario: Enable global restriction initial display
    ...
    And I should see "\local_reportbuilder\event\report_created"
    And I should see "\local_reportbuilder\event\report_updated"
    ...
    And I should not see "\local_reportbuilder\event\report_created"
    And I should not see "\local_reportbuilder\event\report_updated"