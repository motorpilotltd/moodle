 ...
 *
 * @author Sam Hemelryk <sam.hemelryk@t0taralms.com>
...
class behat_local_reportbuilder extends behat_base {
    ...
    public function i_navigate_to_my_report($reportname) {
        \behat_hooks::set_step_readonly(false);
        $this->execute('behat_local_reportbuilder::i_click_on_in_the_totara_menu', 'Reports');
