...
class local_reportbuilder_custom_fields_testcase extends advanced_testcase {
    ...
    public function test_profile_field_defaults() {
        ...
        /** @var local_reportbuilder_generator $generator */
        $generator = $this->getDataGenerator()->get_plugin_generator('local_reportbuilder');
