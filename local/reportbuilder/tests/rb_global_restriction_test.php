...
class local_reportbuilder_rb_global_restriction_testcase extends advanced_testcase {
    ...
    public function test_insert() {
        ...
        $record = $DB->get_record('report_builder_global_restr', array('id' => $id));
    ...
    public function test_update() {
        ...
        $oldrecord = $DB->get_record('report_builder_global_restr', array('id' => $restriction->id), '*', MUST_EXIST);
        ...
        $record = $DB->get_record('report_builder_global_restr', array('id' => $restriction->id), '*', MUST_EXIST);
    ...
    public function test_delete() {
        ...
        $record1 = $DB->get_record('report_builder_global_restr', array('id' => $restriction1->id), '*', MUST_EXIST);

        $data = new stdClass();
        $data->name = 'Some restriction name 2';
        $restriction2 = new rb_global_restriction();
        $restriction2->insert($data);
        $record2 = $DB->get_record('report_builder_global_restr', array('id' => $restriction2->id), '*', MUST_EXIST);

        $restriction2->delete();
        $this->assertEquals($record2, $restriction2->get_record_data());
        $this->assertFalse($DB->record_exists('report_builder_global_restr', array('id' => $restriction2->id)));
        $this->assertTrue($DB->record_exists('report_builder_global_restr', array('id' => $restriction1->id)));
    }
