 ...
 *
 * @author Nathan Lewis <nathan.lewis@t0taralearning.com>
 ...
 * vendor/bin/phpunit --verbose local_reportbuilder_post_config_visibility_where_testcase local/reportbuilder/tests/post_config_visibility_where_test.php
 */
class local_reportbuilder_post_config_visibility_where_testcase extends advanced_testcase {
