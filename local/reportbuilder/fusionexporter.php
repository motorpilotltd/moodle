 ...
 * @author Yuliya Bozhko <yuliya.bozhko@t0taralms.com>
 *
 * @package t0tara
...
$PAGE->set_url('/local/reportbuilder/fusionexporter.php', array('id' => $id));
...
$returnurl = new moodle_url('/local/reportbuilder/fusionexporter.php', array('id' => $id, 'sid' => $sid));
...
if (empty($errors)) {
    ...
    notice(get_string('error:fusionexport', 'gradeexport_fusion', format_string($errordetails)), $url);
}
