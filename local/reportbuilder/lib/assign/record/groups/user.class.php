...
require_once($CFG->dirroot.'/totara/core/lib/assign/groups/user.class.php');

class totara_assign_reportbuilder_grouptype_user_record extends totara_assign_core_grouptype_user {
