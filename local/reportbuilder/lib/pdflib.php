...
function tcpdf_init_k_font_path() {
    ...
    $defaultfonts = $CFG->dirroot.'/local/reportbuilder/lib/tcpdf/fonts/';
...
define('K_PATH_MAIN', $CFG->dirroot.'/local/reportbuilder/lib/tcpdf/');

/** URL path to tcpdf installation folder */
define('K_PATH_URL', $CFG->wwwroot . '/local/reportbuilder/lib/tcpdf/');
...
require_once($CFG->dirroot.'/local/reportbuilder/lib/tcpdf/tcpdf.php');

/**
 * Wrapper class that extends TCPDF (local/reportbuilder/lib/tcpdf/tcpdf.php).
