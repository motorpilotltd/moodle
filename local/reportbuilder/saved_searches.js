...
M.local_reportbuilder_savedsearches = M.local_reportbuilder_savedsearches || {
    ...
    init: function(Y, args) {
        ...
        if (typeof $ === 'undefined') {
            throw new Error('M.local_reportbuilder_savevedsearch.init()-> jQuery dependency required for this module to function.');
        }
        ...
        if (typeof managebutton.attr('id') != 'undefined') {
            var path = M.cfg.wwwroot + '/local/reportbuilder/';
            ...
            totaraDialogs[name] = new totaraDialog(
                ...
                {
                    buttons: buttons,
                    title: '<h2>' + M.util.get_string('managesavedsearches', 'local_reportbuilder') + '</h2>'
                },
