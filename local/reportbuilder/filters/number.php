...
class rb_filter_number extends rb_filter_type {
    ...
    function getOperators() {
        return array(0 => get_string('isequalto', 'local_reportbuilder'),
                     1 => get_string('isnotequalto', 'local_reportbuilder'),
                     2 => get_string('isgreaterthan', 'local_reportbuilder'),
                     3 => get_string('islessthan', 'local_reportbuilder'),
                     4 => get_string('isgreaterorequalto', 'local_reportbuilder'),
                     5 => get_string('islessthanorequalto', 'local_reportbuilder'));
    }
    ...
    function setupForm(&$mform) {
        ...
        $mform->addHelpButton($grp->_name, 'filternumber', 'local_reportbuilder');
        if ($advanced) {
    ...
    function get_sql_filter($data) {
        ...
        $sql = 'CASE WHEN (' . $query . ') IS NULL THEN 0 ELSE ' . \local_reportbuilder\dblib\base::getbdlib()->sql_cast_char2float($query) . ' END ' . $res;
