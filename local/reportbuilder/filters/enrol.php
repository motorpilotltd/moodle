...
class rb_filter_enrol extends rb_filter_type {
    ...
    function setupForm(&$mform) {
        ...
        $mform->addHelpButton($this->name, 'filterenrol', 'local_reportbuilder');
        if ($advanced) {
    ...
    function get_label($data) {
        ...
        if ($value == 1) {
            return get_string('isenrolled', 'local_reportbuilder');
        } else if ($value == 0) {
            return get_string('isnotenrolled', 'local_reportbuilder');
        }
