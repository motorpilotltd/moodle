...
class rb_filter_text extends rb_filter_type {
    ...
    function getOperators() {
        return array(self::RB_FILTER_CONTAINS => get_string('contains', 'local_reportbuilder'),
                     ...
                     self::RB_FILTER_ISEQUALTO => get_string('isequalto', 'local_reportbuilder'),
                     self::RB_FILTER_STARTSWITH => get_string('startswith', 'local_reportbuilder'),
                     self::RB_FILTER_ENDSWITH => get_string('endswith', 'local_reportbuilder'),
