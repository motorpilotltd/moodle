 ...
 */
class rb_filter_costcentre_multi extends rb_filter_type {
    ...
    public function setupForm(&$mform) {
        ...
        $results = $DB->get_records_sql(
                "select costcentre, costcentre from {local_costcentre_user} where userid = :userid AND $bitand group by costcentre",
                ['userid' => $USER->id]
        );
        $centres = array_keys($results);
