...
/**
 * The Activity viewed event class.
 *
 * @package     local_wa_learning_path
 * @author      Łukasz Juchnik <lukasz.juchnik@webanywhere.co.uk>
 * @author      Bartosz Hornik <bartosz.hornik@webanywhere.co.uk>
...
class activity_viewed extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('event_activity_viewed', 'local_wa_learning_path');
    }
 
    public function get_description() {
        return "The user with id {$this->userid} viewed Activity with id {$this->objectid}.";
    }
 
    public function get_url() {
        return new \moodle_url('/local/wa_learning_path/', array('c' => 'activity', 'a' => 'view', 'id' => $this->objectid));
    }
