...
/**
 * The Learning Path updated event.
 *
...
/**
 * The Learning Path updated event class.
 *
 * @package     local_wa_learning_path
 * @author      Łukasz Juchnik <lukasz.juchnik@webanywhere.co.uk>
 * @author      Bartosz Hornik <bartosz.hornik@webanywhere.co.uk>
...
class learning_path_updated extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('event_learning_path_updated', 'local_wa_learning_path');
    }
 
    public function get_description() {
        return "The user with id {$this->userid} updated Learning Path with id {$this->objectid}.";
    }
