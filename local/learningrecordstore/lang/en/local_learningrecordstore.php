...
$string['form:csv:starttime'] = 'Start Date';
$string['form:csv:endtime'] = 'End Date';
...
$string['cpd:error:starttime'] = 'Invalid start time';
$string['cpd:error:endtime'] = 'Invalid end time';
