...
use moodle_url;
use local_learningrecordstore\csvimportstep1;
use local_learningrecordstore\csvimportstep2;
...
class csvimportforms {
    ...
    public function __construct($importid = null, $showcrud = 0) {
        ...
        $this->baseurl = '/local/learningrecordstore/cpd.php';
    ...
    public function admin_form1() {
        ...
        $mform1 = new csvimportstep1(null);
    ...
    public function admin_form2() {
        ...
        $mform2 = new csvimportstep2(null, array('importid' => $this->importid));
    ...
    public function csv_preview($rows) {
        if ($this->importstep == 1) {
            $processor = new \local_learningrecordstore\csvimport($this->cir);
