...
/**
 * The local_reports class created event.
 *
...
/**
 * The local_reports class created event class.
 *
 ...
 * @license     http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class class_created extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventclasscreated', 'local_reports');
    }
    ...
    public function get_description() {
        return "CLASS CREATED | CLASSID: {$this->other['classid']}";
    }
