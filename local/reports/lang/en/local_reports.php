...
//DB fields
$string['learninghistory:idnumber'] = 'Employee Number';
...
$string['learninghistory:classsuppliername'] = 'Provider';
...
$string['learninghistory:idnumber_help'] = 'Employee Number helptext';
$string['learninghistory:costcentre_help'] = 'Cost Centre helptext';
$string['learninghistory:groublocks/arup_mylearning/content.phppname_help'] = 'Group helptext';
...
$string['learninghistory:timemodified'] = 'Last update date';
$string['learninghistory:timemodified_help'] = 'Last update date help';
