...
class certification_messages_form extends \moodleform
{
    function definition()
    {
        ...
        foreach ($messages as $message) {
            $messagebox .= $renderer->display_message_box($message->id, $messagetypes[$message->messagetype], $message->messagetype, $certif->id, $message->recipient, $message->recipientemail, $message->subject, $message->body, $message->triggertime, $message->donotsendtime, $canmanage);
        }
