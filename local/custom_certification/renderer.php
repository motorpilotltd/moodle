...
class local_custom_certification_renderer extends \plugin_renderer_base
{
    ...
    public function display_message_box($messageid, $messagename, $messagetype, $recipient = 0, $recipientemail = null, $messagesubject = null, $messagebody = null, $messagetriggertime = null, $messagedonotsendtime = null, $canmanage = true)
    {
        global $OUTPUT;
        $output = '';
