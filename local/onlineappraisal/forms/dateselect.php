 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class MoodleQuickForm_dateselect extends HTML_QuickForm_text{
    ...
    /** @var string hidden field required for storing epoch time*/
    var $_hiddenfield=false;
     ...
     */
    public function __construct($elementName=null, $elementLabel=null, $attributes=null, $hiddenfield=null) {
    ...
    function toHtml(){
        global $PAGE;
        $renderer = $PAGE->get_renderer('local_onlineappraisal', 'dateselect');
        $this->text = parent::toHtml();
        $this->id = $this->_generateId();
        $this->label = $this->getLabel();
        $this->name = $this->getName();
        $this->dateselectfield = '#id_' . $this->name;
        $this->hiddenfield = $this->_hiddenfield;

        $dateselect = new \local_onlineappraisal\output\dateselect\dateselect($this);

        return $renderer->render($dateselect);
    }
