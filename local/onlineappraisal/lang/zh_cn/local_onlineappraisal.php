...
$string['feedback_intro'] = '请选择三个或更多的同事，能够对你的评价反馈。在大多数地区这种反馈可以是内部或外部的。请参阅你所在地区的具体指导。<br/><br/> 对于内部反馈者，你应考虑从"360 度 反馈"的角度来收集反馈意见，即同级，级别比你高和比你低的同事。你必须选择混合人群。<br/><br/><div data-visible-regions="UKIMEA, EUROPE, AUSTRALASIA"> 其中有一个反馈者可以是外部客户或非常了解你的合作者。</div> <div data-visible-regions="East Asia"><br /><div class="alert alert-warning"> 对于东亚地区, 我们希望反馈仅来自公司内部。外部客户或合作者的评论应该通过公司内部人员来反馈。</div></div> <div data-visible-regions="Americas"><br /><div class="alert alert-warning">For the Americas Region, comments from external clients or collaborators should be fed back through conversations gathered outside of this feedback tool.</div></div> <br /><div class="alert alert-danger"> 注: 除非是由评议人要求提供的反馈，你所请求的反馈信息将在收到后立即发布。否则，你的评议人必须在最后阶段（阶段3），发送给你评议表要你最终评论时显现反馈信息。</div>';
