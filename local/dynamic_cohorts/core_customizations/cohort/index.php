...
foreach($cohorts['cohorts'] as $cohort) {
    ...
    if($cohort->type == \local_dynamic_cohorts\dynamic_cohorts::TYPE_DYNAMIC){
        $line[] = get_string('typedynamic', 'local_dynamic_cohorts');
    }else{
        $line[] = get_string('typestandard', 'local_dynamic_cohorts');
    }
...
$table->head  = array(get_string('name', 'cohort'), get_string('idnumber', 'cohort'), get_string('description', 'cohort'),
    get_string('memberscount', 'cohort'), get_string('type', 'local_dynamic_cohorts'));
$table->colclasses = array('leftalign name', 'leftalign id', 'leftalign description', 'leftalign size', 'leftalign');
