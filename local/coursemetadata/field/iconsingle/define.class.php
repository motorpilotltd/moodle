...
/**
 * Iconsingle local_coursemetadata field.
 *
...
/**
 * Class coursemetadata_define_iconsingle.
 *
 * @copyright  2016 Motorpilot Ltd
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class coursemetadata_define_iconsingle extends \local_coursemetadata\define_base {

    /**
     * Define the settings for an iconsingle custom field.
     *
    ...
    public function define_form_specific($form) {
        ...
        $form->addElement('filemanager', 'icons', get_string('icons', 'coursemetadatafield_iconsingle'), null, $filemanageroptions);
        $form->addHelpButton('icons', 'icons', 'coursemetadatafield_iconsingle');
    }
