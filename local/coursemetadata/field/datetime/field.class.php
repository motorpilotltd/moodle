...
/**
 * Class coursemetadata_field_datetime.
 *
 * @copyright  2016 Motorpilot Ltd
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class coursemetadata_field_datetime extends \local_coursemetadata\field_base {
    ...
    public function display_data() {
        ...
        if (empty($this->data)) {
            return get_string('notset', 'coursemetadatafield_datetime');
        } else {
