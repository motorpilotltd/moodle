...
/**
 * Datetime local_coursemetadata field.
 *
 * @package    coursemetadatafield_datetime
 * @copyright  2016 Motorpilot Ltd
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */

/**
 * Class coursemetadata_define_datetime.
 * 
 * @copyright  2016 Motorpilot Ltd
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class coursemetadata_define_datetime extends \local_coursemetadata\define_base {
    ...
    public function define_form_specific($form) {
        ...
        // Add elements.
        $form->addElement('select', 'param1', get_string('startyear', 'coursemetadatafield_datetime'), $arryears);
        $form->setType('param1', PARAM_INT);
        $form->setDefault('param1', $currentyear);

        $form->addElement('select', 'param2', get_string('endyear', 'coursemetadatafield_datetime'), $arryears);
        $form->setType('param2', PARAM_INT);
        $form->setDefault('param2', $currentyear);

        $form->addElement('checkbox', 'param3', get_string('wanttime', 'coursemetadatafield_datetime'));
    ...
    /**
     * Validate the data from the coursemetadata field form.
     *
     * @param stdClass $data from the add/edit coursemetadata field form
     * @param array $files
    ...
    public function define_validate_specific($data, $files) {
        ...
        if ($data->param1 > $data->param2) {
            $errors['param1'] = get_string('startyearafterend', 'coursemetadatafield_datetime');
        }
    ...
    public function define_after_data($mform) {
        ...
        // If we are adding a new coursemetadata field then the dates have already been set
        ...
        $field = $DB->get_record('coursemetadata_info_field', array('id' => $id), 'param1, param2', MUST_EXIST);
    ...
    /**
     * Preprocess data from the coursemetadata field form before it is saved.
     *
