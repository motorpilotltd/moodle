...
/**
 * Class coursemetadata_field_texarea.
 *
 * @copyright  2016 Motorpilot Ltd
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class coursemetadata_field_textarea extends \local_coursemetadata\field_base {
    ...
    /**
     * Overwrite base class method, data in this field type is potentially too large to be included in the course object.
     *
     * @return bool
     */
    ...
    /**
     * Load course data for this coursemetadata field, ready for editing.
