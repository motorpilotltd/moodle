...
class cmform_class_scheduled_planned extends cmform_class {
    ...
    public function definition() {
        ...
        $mform->addElement('hidden', 'classstatus', 'Planned');
        $mform->setType('classstatus', PARAM_TEXT);
        
        $mform->removeElement('page');
        $this->add_element('page', 'hidden', PARAM_TEXT, null, 'class_scheduled_planned');
        ...
        $startgroup= $this->optional_time_selector('classstarttime');
