...
namespace local_coursemanager\output\navlist;

defined('MOODLE_INTERNAL') || die();

class renderer extends \local_coursemanager\output\renderer {

    public function render_navlist(\local_coursemanager\output\navlist\navlist $navigation) {

        // Call the export_for_template function from class navlist
        $nav = $navigation->export_for_template($this);

        $content = parent::render_from_template('local_coursemanager/navlist', $nav);
        return $content;
    }
}