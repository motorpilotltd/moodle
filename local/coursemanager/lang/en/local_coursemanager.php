...
$string['duplicateidnumber'] = 'This course code is already in use, please use a unique course code';
...
$string['form:course:idnumber'] = 'Course code';
$string['form:course:idnumber_help'] = 'Course code help';
$string['form:course:coursename'] = 'Course name';
