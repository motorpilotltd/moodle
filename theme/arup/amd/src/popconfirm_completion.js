    ...
    return {
        init: function() {
            $(document).ready(function(){
                $("a[href*='togglecompletion']").popConfirm({
                    title: M.util.get_string('popconfirm:togglecompletion:title', 'theme_arup'),
                    content: M.util.get_string('popconfirm:togglecompletion:content', 'theme_arup'),
                    yes: M.util.get_string('popconfirm:togglecompletion:yes', 'theme_arup'),
                    no: M.util.get_string('popconfirm:togglecompletion:no', 'theme_arup'),
                    placement: 'bottom'
                });
            });
            log.debug('Popconfirm init');
        }
    };
