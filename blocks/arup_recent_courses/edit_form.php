...
class block_arup_recent_courses_edit_form extends block_edit_form {
    ...
    protected function specific_definition($mform) {
        ...
        if (get_config('local_coursemetadata', 'version')) {
            ...
            if ($coursemetadatafields) {
                ...
                $mform->addElement('select', 'config_methodologyfield', get_string('methodologyfield', 'block_arup_recent_courses'), $options);
                $mform->addHelpButton('config_methodologyfield', 'methodologyfield', 'block_arup_recent_courses');
            }
        }
