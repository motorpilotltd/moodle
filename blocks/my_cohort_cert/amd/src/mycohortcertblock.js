...
/**
 * Load the my_cohort_cert block tree javscript
 *
 * @module     block_block_my_cohort_cert/block_my_cohort_cert
 * @package    core
...
define(['jquery', 'core/tree'], function($, Tree) {
    return {
        init: function(instanceid, siteAdminNodeId) {
            var adminTree = new Tree(".block_my_cohort_cert .block_tree");
            if (siteAdminNodeId) {
