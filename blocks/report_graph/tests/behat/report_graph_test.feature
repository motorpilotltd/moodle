 @javascript @block_report_graph
Feature: Test the basic functionality of the t0tara report graph block
  In order to test the t0tara report graph block
  As an admin I add an instance
  And I configure it to display as I want

  Scenario: Test I can add and configure a t0tara report graph block instance
