 ...
 * @package block_report_graph
 */
class block_report_graph_testcase extends advanced_testcase {

    use \block_report_graph\phpunit\block_testing;

    /**
     * @var block_report_graph
     */
    ...
    public function test_get_content() {
        ...
        $this->assertContains('blocks/report_graph/ajax_graph.php?blockid='.$this->blockinstance->instance->id, $content->text);
    }
}