...
class block_report_graph extends block_base {
    ...
    public function specialization() {
        ...
        if (!empty($this->config->graphimage_maxwidth)) {
            $this->graphimage_maxwidth =
                    \block_report_graph\util::normalise_size_and_user_input($this->config->graphimage_maxwidth);
        }
        if (!empty($this->config->graphimage_maxheight)) {
            $this->graphimage_maxheight =
                    \block_report_graph\util::normalise_size_and_user_input($this->config->graphimage_maxheight);
        }
    }
    ...
    public function get_content() {
        ...
        if (empty($this->config->hidereportlink) && reportbuilder::is_capable($this->rawreport->id, $USER->id)) {
