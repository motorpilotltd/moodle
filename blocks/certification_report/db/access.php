...
$capabilities = array(
    ...
    'block/certification_report:myaddinstance' => array(
        'captype' => 'write',
    ...
    'block/certification_report:addinstance' => array(
    ...
    'block/certification_report:set_exemption' => array(
        'captype' => 'write',
        'contextlevel' => CONTEXT_BLOCK,
        'archetypes' => array(
            'manager' => CAP_ALLOW
    ...
    'block/certification_report:reset_certification' => array(
        'captype' => 'write',
        'contextlevel' => CONTEXT_BLOCK,
        'archetypes' => array(
            'manager' => CAP_ALLOW
