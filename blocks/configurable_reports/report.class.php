...
/* END CORE MOD */
    ...
    public function print_report_page() {
        ...
        // Debug.
/* BEGIN CORE MOD */
        // Removed: $debug = optional_param('debug', false, PARAM_BOOL);
        if (!empty($this->config->debug) && !empty($this->sql)) {
/* END CORE MOD */
...
/* BEGIN CORE MOD */
        ...
        echo \html_writer::start_div('centerpara');
        echo \html_writer::empty_tag('br');
        echo \html_writer::link($returnurl, get_string('backto', 'block_configurable_reports', core_text::strtolower(get_string('course'))));
