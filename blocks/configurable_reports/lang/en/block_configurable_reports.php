...
/* BEGIN CORE MOD */
$string['addreportcourse'] = "Add course report";
$string['addreportsite'] = "Add sitewide report";
/* END CORE MOD */
...
$string['modfield'] = 'Activity field';
$string['filtermods'] = 'Activities';
$string['filtermods_summary'] = 'This filter shows a list of available activities.';
$string['filter_mod_type'] = 'Choose filter type:';
$string['filter_mod_type_0'] = 'Show all';
$string['filter_mod_type_1'] = 'Show those containing ANY of the chosen activities';
$string['filter_mod_type_2'] = 'Show those containing ALL chosen activities';

$string['enrol'] = 'Enrolment methods';
$string['report_enrol'] = 'Enrolment report';
$string['enrolfield'] = 'Enrolment field';
$string['filterenrol'] = 'Enrolment methods';
$string['filterenrol_summary'] = 'This filter shows a list of available enrolment methods.';
$string['filter_enrol_type'] = 'Choose filter type:';
$string['filter_enrol_type_0'] = 'Show all';
$string['filter_enrol_type_1'] = 'Show those containing ANY of the chosen enrolment methods';
$string['filter_enrol_type_2'] = 'Show those containing ALL chosen enrolment methods';
...
$string['filtercompletiondate'] = 'Completion date';
$string['filtercompletiondate_summary'] = 'To filter by completion date.';

$string['report_halogencompletion'] = 'Halogen completion report';
$string['userregionfield'] = 'User region field';
$string['cuserregionfield'] = 'User region field condition';
$string['userregion'] = 'User region';
$string['filteruserregion'] = 'User region';
$string['regionid'] = 'Preferred user region';
$string['actregionid'] = 'Actual user region';
$string['georegionid'] = 'Geographical user region';
$string['statusflag'] = 'Status';
$string['statusflag:null'] = 'OK';
$string['notset'] = 'NOT SET';
$string['userregionunavailable'] = 'User region filter unavailable.';
// Completion date filter strings as per report_tapscompletion

$string['badpermissions'] = 'Sorry, you do not have permission to carry out that action.';
