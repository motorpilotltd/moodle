...
/* END CORE MOD */
        ...
        $table->data[] = [
/* BEGIN CORE MOD */
            '<a href="viewreport.php?id='.$r->id.'&amp;courseid='.$course->id.'">'.format_string($r->name).'</a>',
/* END CORE MOD */
            $coursename,
...
/* BEGIN CORE MOD */
    if ($course->id != SITEID) {
        $addreportlink = '<div class="addbutton"><a class="btn" href="'.$CFG->wwwroot.'/blocks/configurable_reports/editreport.php?courseid='.$course->id.'">'.(get_string('addreportcourse','block_configurable_reports')).'</a>'
            . ' <a class="btn" href="'.$CFG->wwwroot.'/blocks/configurable_reports/editreport.php?courseid='.SITEID.'">'.(get_string('addreportsite','block_configurable_reports')).'</a></div>';
    } else {
        $addreportlink = '<div class="addbutton"><a class="btn" href="'.$CFG->wwwroot.'/blocks/configurable_reports/editreport.php?courseid='.$course->id.'">'.(get_string('addreport','block_configurable_reports')).'</a></div>';
    }

    echo $OUTPUT->heading($addreportlink);
/* END CORE MOD */
