...
$capabilities = array(
    ...
    'block/wa_learning_path_nav:myaddinstance' => array(
        'captype' => 'write',
    ...
    'block/wa_learning_path_nav:addinstance' => array(
    ...
    'block/wa_learning_path_nav:manage' => array(
        'riskbitmask' => RISK_SPAM | RISK_XSS,
        'captype' => 'write',
        'contextlevel' => CONTEXT_SYSTEM,
        'archetypes' => array(
