 ...
 *
 * NOTE: this is a clone of /local/reportbuilder/ajax/instantreport.php
 */
...
$block = $DB->get_record('block_instances', array('id' => $blockid, 'blockname' => 'report_table'), '*', MUST_EXIST);
