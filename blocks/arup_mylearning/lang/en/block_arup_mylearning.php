...
$string['alert:edit:noteditable'] = 'This is not an editable CPD record.';
...
$string['cpd:originname'] = 'Class name';
$string['cpd:classtype'] = 'Learning method';
$string['cpd:duration'] = 'Duration';
$string['cpd:starttime'] = 'Start time';
$string['cpd:endtime'] = 'End time';
$string['cpd:durationunits'] = 'Duration units';
