...
/* BEGIN CORE MOD */
     $AxisBorderOffset = isset($Format["AxisBorderOffset"]) ? $Format["AxisBorderOffset"] : 6;
/* END CORE MOD */
...
/* BEGIN CORE MOD */
     $AxisFontColorR	= isset($Format["AxisFontColorR"]) ? $Format["AxisFontColorR"] : $this->pChartObject->FontColorR;
     $AxisFontColorG	= isset($Format["AxisFontColorG"]) ? $Format["AxisFontColorG"] : $this->pChartObject->FontColorG;
     $AxisFontColorB	= isset($Format["AxisFontColorB"]) ? $Format["AxisFontColorB"] : $this->pChartObject->FontColorB;
     $AxisFontColorA	= isset($Format["AxisFontColorA"]) ? $Format["AxisFontColorA"] : $this->pChartObject->FontColorA;
/* END CORE MOD */
...
/* BEGIN CORE MOD */
     $LineWeight    = isset($Format["LineWeight"]) ? $Format["LineWeight"] : 1;
/* END CORE MOD */
...
/* BEGIN CORE MOD */
     $DrawInReverse    = isset($Format["DrawInReverse"]) ? $Format["DrawInReverse"] : FALSE;
/* END CORE MOD */
...
/* BEGIN CORE MOD */
       if ( $AxisBorderOffset ) { $Options["BorderOffset"] = $AxisBorderOffset; }
/* END CORE MOD */

       $Options["FontName"] = $AxisFontName;
       $Options["FontSize"] = $AxisFontSize;
/* BEGIN CORE MOD */
       $Options["R"] = $AxisFontColorR;
       $Options["G"] = $AxisFontColorG;
       $Options["B"] = $AxisFontColorB;
       $Options["A"] = $AxisFontColorA;
/* END CORE MOD */
...
/* BEGIN CORE MOD */
     $ID = 0; $Plot = array(); $Polygons = array();
/* END CORE MOD */
...
/* BEGIN CORE MOD */
         if (!isset($Palette[$ID]))
          {
           $Palette[$ID] = array('R'=>0,'G'=>0,'B'=>0,'Alpha'=>100);
          }
          $Polygon[$ID] = isset($DataS["Polygon"]) ? $DataS["Polygon"] : TRUE;
/* END CORE MOD */
...
/* BEGIN CORE MOD */
       ...
       $Color = array("R"=>$Palette[$ID]["R"],"G"=>$Palette[$ID]["G"],"B"=>$Palette[$ID]["B"],"Alpha"=>$Palette[$ID]["Alpha"],"Surrounding"=>$PointSurrounding, "Weight"=>$LineWeight);
/* END CORE MOD */

       /* Draw the polygons */
       if ( $DrawPoly && $Polygon[$ID] )
        {
         if ($PolyAlpha != NULL)
          $Color = array("R"=>$Palette[$ID]["R"],"G"=>$Palette[$ID]["G"],"B"=>$Palette[$ID]["B"],"Alpha"=>$PolyAlpha,"Surrounding"=>$PointSurrounding, "Weight"=>$LineWeight);
