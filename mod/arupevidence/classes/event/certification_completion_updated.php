...
/**
 * The mod_arupevidence certification completion updated event.
 *
...
/**
 * The mod_arupevidence certification completion updated event class.
 *
 * @property-read array $other {
 *      Extra information about event.
 *
 *      - int certifid: Certification ID.
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class certification_completion_updated extends \core\event\base {
    ...
    public function get_description() {
        return "CERTIFICATION COMPLETION UPDATED | "
            . "User: {$this->relateduserid} | "
            . "Certification: {$this->other['certifid']} | "
