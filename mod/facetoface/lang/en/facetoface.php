...
/* BEGIN CORE MOD */
$string['completionattended'] = 'Mark as completed if fully attended';
$string['completionbooked'] = 'Mark as completed if booked on a session';
/* END CORE MOD */
...
/* BEGIN CORE MOD */
$string['durationcode'] = ' (HH:00/HH:30)';
/* END CORE MOD */
...
/* BEGIN CORE MOD */
$string['facetofacenotavailable'] = 'Sorry, you are not currently able view this activity.';
/* END CORE MOD */
...
/* BEGIN CORE MOD */
$string['placeholder:sessioninfolink'] = '[sessioninfolink]';
/* END CORE MOD */
...
/* BEGIN CORE MOD */
$string['signupnotavailable'] = 'Sorry, you are not currently able to sign-up for this session.';
/* END CORE MOD */
...
/* BEGIN CORE MOD */
$string['userdeletedcancel'] = 'User deleted';
/* END CORE MOD */
...
$string['validation:durationnothourorhalf'] = 'Duration can only be expressed in half hour periods';
/* END CORE MOD */
