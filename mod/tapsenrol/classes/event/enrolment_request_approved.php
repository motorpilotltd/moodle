...
/**
 * The mod_tapsenrol enrolment request approved event.
 *
...
/**
 * The mod_tapsenrol enrolment request approved event class.
 *
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class enrolment_request_approved extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventenrolmentrequestapproved', 'mod_tapsenrol');
    }
    ...
    public function get_description() {
        return "ENROLMENT REQUEST APPROVED | Status: {$this->other['status']} | Email: {$this->other['email']} | "
