...
/**
 * The mod_tapsenrol enrolment created event.
 *
...
/**
 * The mod_tapsenrol enrolment created event class.
 *
...
class enrolment_created extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventenrolmentcreated', 'mod_tapsenrol');
    }
    ...
    public function get_description() {
        return "ENROLMENT CREATED | Enrolment ID: {$this->other['enrolmentid']} | Staff ID: {$this->other['staffid']} | "
