...
$string['downloadtextformat_help'] = 'This feature enables you to save all the responses of a questionnaire to a CSV file.
...
$string['email'] = 'Email';
/* BEGIN CORE MOD */
$string['emailhtml'] = '{$a->username} has responded to the questionnaire activity : <i>\'{$a->questionnaire}\'</i><br /><br />
You can view details <a href="{$a->url}">here</a>.';
$string['emailtext'] = '{$a->username} has responded to the questionnaire activity : \'{$a->questionnaire}\'
...
/* BEGIN CORE MOD */
$string['email:summary:body'] = '<p>Dear {$a->name},</p>
<p>Thank you for completing the {$a->questionnaire} questionnaire.</p>
<p>To view a summary of your responses please follow the link below.</p>
<p><a href="{$a->url}">View summary</a></p>';
$string['email:summary:subject'] = '{$a}: Submission summary';
$string['resetownresponse'] = 'Edit your response';
$string['resetresponses'] = 'Reset Responses';
$string['resetresponses:completed'] = 'Completed';
$string['resetresponses:instructions'] = 'Respondents shown below have a completed response, and no currently uncompleted responses, that may be reset (i.e. re-opened for editing).';
$string['resetresponses:invalidid'] = 'Sorry, the submitted response id does not match a valid response that is able to be reset, please try again.';
$string['resetresponses:noresponses'] = 'No reponses suitable for resetting.';
$string['resetresponses:notvalid'] = 'Responses can only be reset on questionnaires that can only be filled in once, are not anonymous and are open.';
$string['resetresponses:reset'] = 'Reset';
$string['resetresponses:success'] = 'The chosen response has successfully been reset.';
$string['sendsummary'] = 'Send summary email';
$string['sendsummary_help'] = 'When a user completes the questionnaire send them a summary email which includes a link to view their responses (login not required).';
$string['usercanreset'] = 'User can reset response';
$string['usercanreset_help'] = 'Users are allowed to reset their response, to enable editing and re-submitting. '
    . 'NB. Responses can only be reset on questionnaires that can only be filled in once, are not anonymous and are open.';
/* END CORE MOD */