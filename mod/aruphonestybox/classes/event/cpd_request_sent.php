...
/**
 * The mod_aruphonestybox cpd request sent event.
 *
...
namespace mod_aruphonestybox\event;

defined('MOODLE_INTERNAL') || die();

/**
 * The mod_aruphonestybox cpd request sent event class.
 *
...
class cpd_request_sent extends \core\event\base {
    ...
    protected function init() {
        ...
        $this->data['objecttable'] = 'aruphonestybox';
    }
    ...
    public static function get_name() {
        return get_string('eventcpdrequestsent', 'mod_aruphonestybox');
    }
